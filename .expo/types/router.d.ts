...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/_sitemap` | `/app` | `/components/ExternalLink` | `/components/GameBoard` | `/components/ThemedText` | `/components/ThemedView` | `/components/__tests__/ThemedText-test` | `/components/navigation/TabBarIcon` | `/data/level1` | `/data/level2` | `/utils/checkWordCompletion` | `/utils/cluePathGenerator` | `/utils/getClueColor` | `/utils/levelTemplate`;
